...
type PortalTab = 'PORTFOLIOS' | 'WALLEX_API' | 'TAX_REPORT' | 'ALERTS' | 'JOURNAL';
...
export const PersonalizedUserPortal: React.FC<Props> = ({
  ...
  const [activeTab, setActiveTab] = useState<PortalTab>('PORTFOLIOS');
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-5xl my-auto rounded-3xl border border-slate-200/80 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl shadow-2xl overflow-hidden transition-all flex flex-col max-h-[90vh]"
      ...
      >
        ...
        <div className="relative p-5 sm:p-6 bg-gradient-to-r from-emerald-500/15 via-teal-500/10 to-indigo-500/15 border-b border-slate-200/80 dark:border-slate-800 shrink-0">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pe-10">
            <div className="flex items-center gap-3.5">
              <div className="w-13 h-13 rounded-2xl bg-gradient-to-tr from-emerald-500 to-cyan-500 flex items-center justify-center text-white shadow-lg shadow-emerald-500/25 ring-2 ring-emerald-500/20 text-xl font-black">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="px-2 py-0.5 rounded-md text-[10px] font-mono text-slate-500 bg-slate-100 dark:bg-slate-800">
                    {isFa ? 'عضو رسمی سامانه' : 'Verified Member'}
                  </span>
                </div>
          ...
          {/* Navigation Tabs (Member-Only) */}
          <div className="flex items-center gap-1 overflow-x-auto mt-5 pt-1 pb-1 scrollbar-none border-t border-slate-200/60 dark:border-slate-800/80">
            <button
              type="button"
            ...
            >
              ...
              <span>{isFa ? 'پورتفوهای ابری من' : 'Saved Portfolios'}</span>
            </button>
            ...
            >
              ...
              <span>{isFa ? 'اتصال مستقیم به API والکس' : 'Wallex API Sync'}</span>
            </button>
            ...
            >
              ...
              <span>{isFa ? 'گزارش رسمی مالیات و دارایی' : 'Tax & Accounting'}</span>
            </button>
            ...
            >
              ...
              <span>{isFa ? 'هشدارهای سود و تارگت' : 'Price & P&L Alerts'}</span>
            </button>
            ...
            >
              ...
              <span>{isFa ? 'ژورنال روانشناسی معامله' : 'Trading Journal'}</span>
            </button>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 space-y-6 overflow-y-auto flex-1">
          ...
          {activeTab === 'WALLEX_API' && (
            <div className="space-y-6">
              <div className="p-4 sm:p-5 rounded-2xl border border-indigo-500/25 bg-indigo-500/5 dark:bg-indigo-950/20 backdrop-blur-md space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        {isFa 
                          ? 'همگام‌سازی خودکار سفارش‌ها و معاملات انجام‌شده در صرافی والکس بدون نیاز به دانلود فایل اکسل یا عکس.' 
                ...
                <form onSubmit={handleSaveWallexApi} className="space-y-3.5 pt-2">
                  <div>
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    />
                    <label htmlFor="autoSyncCheck" className="text-xs text-slate-600 dark:text-slate-300 cursor-pointer">
                ...
                {user.wallexApi?.lastSyncAt && (
                  <div className="text-[11px] text-slate-500 dark:text-slate-400 pt-2 border-t border-indigo-200/40 dark:border-indigo-900/40">
                    <span>{isFa ? 'آخرین همگام‌سازی موفق با سرور والکس:' : 'Last successful sync:'} </span>
                    <span className="font-mono font-semibold">{new Date(user.wallexApi.lastSyncAt).toLocaleString(isFa ? 'fa-IR' : 'en-US')}</span>
                  </div>
                )}
              </div>
            </div>
          ...
          {/* TAB 3: FORMAL TAX & FISCAL REPORT */}
          {activeTab === 'TAX_REPORT' && (
            <div className="space-y-6">
              <div className="p-4 sm:p-5 rounded-2xl border border-amber-500/30 bg-amber-500/5 dark:bg-amber-950/20 backdrop-blur-md space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        {isFa 
                          ? 'محاسبه سود خالص مشمول، کسر زیان‌های تجاری و کارمزدهای معاملاتی به عنوان هزینه قابل قبول.' 
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-600 hover:bg-amber-500 text-white text-xs font-bold shadow-xs transition cursor-pointer self-start sm:self-auto"
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full py-2 px-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-xs font-bold"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full py-2 px-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-xs font-bold font-mono"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-2 pt-6">
                    ...
                    />
                    <label htmlFor="deductFeeCheck" className="text-xs text-slate-600 dark:text-slate-300 cursor-pointer">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3">
                  <div className="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                    <span className="text-[10px] text-slate-500 block">{isFa ? 'سود ناخالص محقق‌شده:' : 'Gross Realized Gain:'}</span>
                  ...
                  <div className="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                    <span className="text-[10px] text-slate-500 block">{isFa ? 'زیان قابل جبران:' : 'Allowable Loss Offsets:'}</span>
                  ...
                  <div className="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                    <span className="text-[10px] text-slate-500 block">{isFa ? 'کارمزد قابل کسر هزینه:' : 'Deductible Fees:'}</span>
                    <span className="text-sm font-mono font-bold text-amber-600 dark:text-amber-400">
                      {deductibleFees.toLocaleString()}
                    </span>
                  </div>

                  <div className="p-3 rounded-xl bg-gradient-to-tr from-amber-500/15 to-amber-500/5 border border-amber-500/40">
                    <span className="text-[10px] text-amber-800 dark:text-amber-300 font-bold block">{isFa ? 'برآورد مالیات تکلیفی:' : 'Estimated Tax Due:'}</span>
          ...
          {/* TAB 4: PRICE & P&L ALERTS */}
          {activeTab === 'ALERTS' && (
            <div className="space-y-6">
              {/* Alert Creation Form */}
              <div className="p-4 sm:p-5 rounded-2xl border border-cyan-500/30 bg-cyan-500/5 dark:bg-cyan-950/20 backdrop-blur-md space-y-4">
                <div className="flex items-center gap-3">
                ...
                <form onSubmit={handleAddAlert} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 pt-2">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="TON/TMN"
                      className="w-full py-2 px-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-xs font-mono font-bold uppercase"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="480000"
                      className="w-full py-2 px-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-xs font-mono font-bold"
                    />
                  </div>
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <input
                      ...
                      className="w-full py-2 px-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-xs"
                    />
                  </div>
                  ...
                  <div className="sm:col-span-1 flex items-end">
                    <button
                      type="submit"
                      className="w-full py-2 px-4 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white font-bold text-xs shadow-md shadow-cyan-600/25 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1.5"
                    >
          ...
          {/* TAB 5: TRADE PSYCHOLOGY & JOURNAL */}
          {activeTab === 'JOURNAL' && (
            <div className="space-y-6">
              {/* Journal Entry Form */}
              <div className="p-4 sm:p-5 rounded-2xl border border-purple-500/30 bg-purple-500/5 dark:bg-purple-950/20 backdrop-blur-md space-y-4">
                <div className="flex items-center gap-3">
                ...
                <form onSubmit={handleAddJournal} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 pt-2">
                  ...
                  <div className="sm:col-span-1 flex items-end">
                    <button
                      type="submit"
                      className="w-full py-2 px-4 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs shadow-md shadow-purple-600/25 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1.5"
                    >
                      <Plus className="w-4 h-4" />
